        ...
        <div class="col-lg-6 col-lg-offset-3">
            ...
            <form action="proses.php" method="post">
                <div class="form-group">
                    ...
                    <input type="tel" name="identitas" id="identitas" class="form-control" value="<?=$data['nomor_identitas']?>" required autofocus>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" name="telp" id="telp" class="form-control" value="<?=$data['no_telp']?>" required>
                </div>
